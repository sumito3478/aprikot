...
trait Check {
  ...
  trait CRC32 {
    ...
    private[this] lazy val rp = JInteger.reverse(poly)
   ...
   */
  object CRC32IEEE extends CRC32 {
    def poly = 0x04c11db7
  }

  /**
   * CRC32-K(Koopman) implementation.
   */
  object CRC32K extends CRC32 {
    def poly = 0x741B8CD7
  }
  /**
  ...
  /**
   * CRC64-ECMA182 implementation.
   */
  object CRC64ECMA extends CRC64 {
    def poly: Long = 0x42F0E1EBA9EA3693L
  }
